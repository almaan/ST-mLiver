...
png("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/revision/revision_plots/rev3/cell_count_cluster_violin.png",  width = 3000, height = 1500, res = 300)
print(VlnPlot(se.cca,
        features = "cell_count",
        cols = cluster.cols))
dev.off()

png("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/revision/revision_plots/rev3/cell_count_cluster_umap.png", width = 8400, height = 6000, res = 600)
print(FeaturePlot(se.cca, features = "cell_count",
            label = T, 
            label.size = 12,
            pt.size = 2,
            cols = c("darkslategray2", "darkslategray4", "darkslategrey")) + 
...
se1 <- SubsetSTData(se.cca, spots = rownames(subset(se.cca[[]], sample_id %in% c(8))))

gg <- data.frame(nCount = se.cca@meta.data$nCount_RNA,
                 nCell = se.cca@meta.data$cell_count)

png("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/revision/revision_plots/rev3/cellcount_cor/cell_count_RNA_count_cor_CN65_E1.png", width = 4200, height = 3000, res = 600)
