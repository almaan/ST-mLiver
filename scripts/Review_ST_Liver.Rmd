...
print(hist(cca_cells_spot$count, main = "", xlab = "ncell/spot", plot = T, xlim = range(0:80), ylim = range(0:1000)))
dev.off()

#Run shapiro-wilk-normality test to test for normal distribution of cell count across spots: 

shapiro.test(cca_cells_spot$count)
...
print(ggplot(gg, aes(nCount, nCell)) +
  geom_point() +
  stat_cor(method = "pearson"))
dev.off()
```
