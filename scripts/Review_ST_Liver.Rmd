...
print(hist(cca_cells_spot$count, main = "", xlab = "ncell/spot", plot = T, xlim = range(0:150), ylim = range(0:1000)))
#dev.off()
...
se.cca_c <- readRDS("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/supplementary/cca-object_cellcount_norm")

DimPlot(se.cca, pt.size = 1 , label = T, cols = cluster.cols)

DimPlot(se.cca_c, pt.size = 1 , label = T, cols = cluster.cols)
...
table(se.cca@meta.data[, c("seurat_clusters", "cc_seurat_clusters")])
