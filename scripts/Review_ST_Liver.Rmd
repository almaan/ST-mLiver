...
gg <- data.frame(nCount = se.cca_cc@meta.data$nCount_RNA,
                 nCell = se.cca_cc@meta.data$cell_count)

png("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/revision/revision_plots/rev3/cellcount_cor_cc_norm/cell_count_RNA_count_cor_cc_CN65_E1.png", width = 4200, height = 3000, res = 600)
...
cluster.cols.cc = c("blue3","yellow3", "red3", "darkorange1","green4", "turquoise3")
...
```{r, export gt objects for markers}

png("~/Desktop/PhDprojectFranziskaHildebrandt/Publication_Liver/revision/revision_plots/rev2/markers-cca-5.png", width = 8400, height = 6000, res = 600)
gt(markers.cca.5, rownames_to_stub = TRUE)
dev.off()
...
cc_clusters <- se.cca_cc[["seurat_clusters"]]
...
convert_new <- c("0" = "portal cluster", "1" = "cluster 0" ,"2" = "central cluster", "3" = "heme cluster", "4" = "cluster 5", "5" = "immunity cluster")


se.cca$label_old <- convert_old[as.character(se.cca$seurat_clusters)]
se.cca$label_new <- convert_new[as.character(se.cca$cc_seurat_clusters)]
